...
export function Breadcrumbs({
  ...
  return (
    <nav className="flex px-6 py-3 border-b border-default font-sans bg-neutral-primary" aria-label="Breadcrumb">
      <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        {/* Step 1: Workspace/Home */}
        <li className="inline-flex items-center">
          <Link 
            href="/dash" 
            className="inline-flex items-center text-sm font-medium text-body hover:text-fg-brand transition-colors"
          >
