    ...
    <nav className="flex px-6 py-3 border-b border-gray-200 dark:border-zinc-800 font-sans bg-white dark:bg-zinc-950" aria-label="Breadcrumb">
      <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li className="inline-flex items-center">
          <Link 
            href="/dash" 
            className="inline-flex items-center text-sm font-medium text-gray-600 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
          >
