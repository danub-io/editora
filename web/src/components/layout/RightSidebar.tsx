...
export function RightSidebar() {
  ...
  const { activeChapterId, getChapter } = useProjectStore();
          ...
          <div className="p-5 flex-1 overflow-y-auto">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex gap-1.5">
                  <button className="px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 rounded text-[12px] font-medium text-slate-700 transition-colors">Aa</button>
                  <button className="px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 rounded text-[12px] font-medium text-slate-700 transition-colors">Match word</button>
                </div>
                <button className="px-4 py-1.5 bg-slate-500 hover:bg-slate-600 text-white rounded text-[12px] font-medium transition-colors">Find</button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center justify-end gap-1.5">
                <button className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 rounded text-[12px] font-medium text-slate-700 transition-colors">Replace all</button>
                <button className="px-4 py-1.5 bg-slate-500 hover:bg-slate-600 text-white rounded text-[12px] font-medium transition-colors">Replace</button>
              </div>
            </div>
          </div>
        </div>
