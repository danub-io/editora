...
export const metadata: Metadata = {
  title: "Biblioteca — Aura Editorial",
};
    ...
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      <main id="main-content" className="flex-1 flex items-center justify-center px-edge-margin-mobile md:px-edge-margin-desktop">
        <div className="text-center max-w-md">
          <Library className="w-12 h-12 mx-auto mb-6 text-on-surface-variant" />
          <h1 className="font-display-lg text-primary mb-4">Biblioteca</h1>
