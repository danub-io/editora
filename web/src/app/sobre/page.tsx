    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 flex flex-col justify-between text-gray-650 dark:text-zinc-400 font-sans antialiased pt-16">
      ...
      <main className="flex-1 max-w-5xl mx-auto px-6 py-12 md:py-20 space-y-12">
        ...
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <p className="text-sm md:text-base text-gray-600 dark:text-zinc-450 leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch">
          ...
          <div className="bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 p-8 rounded-lg space-y-4 flex flex-col justify-between min-h-[220px]">
            <div className="bg-indigo-50 dark:bg-indigo-950/40 p-3 rounded-lg w-fit border border-indigo-100 dark:border-indigo-900/50">
          ...
          <div className="bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 p-8 rounded-lg space-y-4 flex flex-col justify-between min-h-[220px]">
            <div className="bg-indigo-50 dark:bg-indigo-950/40 p-3 rounded-lg w-fit border border-indigo-100 dark:border-indigo-900/50">
              <Heart size={24} className="text-indigo-600 dark:text-indigo-400" />
            </div>
            <div>
          ...
          <div className="md:col-span-2 bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 p-8 rounded-lg space-y-4">
            <div className="bg-indigo-50 dark:bg-indigo-950/40 p-3 rounded-lg w-fit border border-indigo-100 dark:border-indigo-900/50 mb-2">
            ...
            <p className="text-gray-550 dark:text-zinc-400 text-xs md:text-sm leading-relaxed text-justify">
