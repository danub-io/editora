      ...
      <main id="main-content" className="flex-1 max-w-5xl mx-auto px-6 py-12 w-full">
        ...
        <header className="mb-12 border-b border-gray-200 dark:border-zinc-800 pb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 dark:text-zinc-100 uppercase tracking-tight flex items-center gap-3">
            <Scale className="w-8 h-8 text-indigo-500 dark:text-indigo-400" /> Termos de Uso
          </h1>
        ...
        <div className="max-w-3xl font-sans text-sm leading-relaxed text-gray-700 dark:text-zinc-300 space-y-8">
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-gray-900 dark:text-zinc-100 font-sans">1. Aceitação dos Termos</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-gray-900 dark:text-zinc-100 font-sans">2. Propriedade dos Manuscritos</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-gray-900 dark:text-zinc-100 font-sans">3. Diretrizes de Publicação no Acervo</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-gray-900 dark:text-zinc-100 font-sans">4. Limitação de Responsabilidade</h2>
            <p>
